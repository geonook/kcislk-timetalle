...
- ✅ 優化 Zeabur 專案類型自動偵測機制
- ✅ 完善 Staging 環境功能開關設定
- ✅ 新增完整的多環境配置文檔（ZEABUR-SETUP.md）
- ✅ 統一 Node 版本為 20，確保環境一致性

### v2.3.1 (2025-11-06) - 功能開關機制
- ✅ 實作環境變數功能開關（VITE_ENABLE_EXAM_PROCTOR）
- ✅ 支援期間限定功能彈性控制（Staging 顯示 / Production 隱藏）
- ✅ 完善 Staging/Production 雙環境工作流程
