...
> **Documentation Version**: 5.6 (Full System RWD Optimization)
> **Last Updated**: 2026-01-05
> **Project**: KCISLK 課表查詢系統 (v2.5.0 - Full System RWD Optimization)
> **Description**: 康橋國際學校林口校區小學部課表查詢系統，支援班級、學生、教師課表查詢與列印、期末考監考管理，並提供中英文雙語介面
> **Architecture**: React 19 SPA + Flask 3.1 API (fully decoupled)
> **Features**: KCISLK 自訂 Logo、英文瀏覽器標題、三種課表類型整合、英文班級純淨顯示、完整8堂課表顯示、智能搜尋、深色模式、**全系統響應式設計優化**、z-index 層級系統、環境變數功能開關、專業黑白列印格式（班級/教師/學生）
> **Current Status**: ✅ 專案完全完成並優化 v2.5.0 - 所有功能已實現、全系統 RWD 響應式設計優化完成、生產環境穩定運行

This file provides essential guidance to Claude Code (claude.ai/code) when working with code in this repository.

## 📝 **變更日誌**

### v5.6 (2026-01-05) - Full System RWD Optimization
**全系統響應式設計優化：**
- ✅ StudentPage RWD 優化（標題/副標題/卡片/統計網格響應式）
- ✅ TeacherPage RWD 優化（標題/副標題/卡片/統計網格響應式）
- ✅ ClassPage RWD 優化（麵包屑/標題響應式）
- ✅ NotFoundPage RWD 優化（404 標題響應式）
- ✅ ExamProctorPage RWD 優化（手機版橫向 Tab、iPad 雙欄卡片佈局）
- ✅ 新增 `scrollbar-hide` CSS 工具類（手機版水平滾動選單）
- ✅ 期末考監考系統完整 i18n 翻譯支援（中英文）
- ✅ 更新版本至 v2.5.0

**RWD 優化模式標準化：**
- 標題：`text-2xl sm:text-3xl md:text-4xl lg:text-5xl`
- 卡片內距：`p-4 sm:p-6 md:p-8`
- 統計網格：`grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5/6`
- 麵包屑：`text-xs sm:text-sm`

### v5.5 (2025-11-13) - Class Timetable Print Feature
**新增班級課表列印功能文檔：**
- ✅ 記錄班級課表列印功能實作（v2.4.1）
- ✅ 新增 `convertToUnifiedTimetable()` 工具函數說明
- ✅ 更新專案功能描述（加入班級課表列印）
- ✅ 更新版本至 2.4.1
- ✅ 更新專案完成狀態
...
> **✅ 專案完全完成並優化 v2.5.0** - 2026年1月5日
>
> 所有核心功能已實現、全系統 RWD 響應式設計優化完成：
> - ✅ 完整的學生課表查詢系統（1,036+ 學生）
> - ✅ 完整的教師課表查詢系統
> - ✅ 完整的班級課表查詢系統（42 個班級）
> - ✅ 三種課表類型整合顯示（英文班、Home Room、EV & myReading）
> - ✅ **期末考監考管理系統** - 12 個 GradeBand、完整 i18n 翻譯
> - ✅ **全系統 RWD 響應式設計優化**（v2.5.0）- 手機/iPad/桌面完美適配
> - ✅ **環境變數功能開關** - 期間限定功能彈性控制
> - ✅ **班級/學生/教師課表列印功能** - 專業黑白列印格式
...
> - ✅ 手機版體驗優化（44px 觸控目標、橫向 Tab 選擇器）
> - ✅ 空堂清晰標示（Free Period 含時間顯示）
> - ✅ Zeabur 生產環境穩定運行
>
> **系統狀態**: 生產環境穩定運行，零錯誤
> **使用者體驗**: 流暢、直觀、快速響應、全裝置適配
> **技術債務**: 零技術債務，代碼整潔
...
*專案完成並優化: 2026-01-05*
*文檔最後更新: 2026-01-05*
*文檔版本: 5.6 (Full System RWD Optimization)*
*系統版本: v2.5.0*