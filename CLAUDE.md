...
> **Documentation Version**: 5.5 (Class Timetable Print Feature)
> **Last Updated**: 2025-11-13
> **Project**: KCISLK 課表查詢系統 (v2.4.1 - Class Timetable Print Implementation)
> **Description**: 康橋國際學校林口校區小學部課表查詢系統，支援班級、學生、教師課表查詢與列印、期中考監考管理，並提供中英文雙語介面
> **Architecture**: React 19 SPA + Flask 3.1 API (fully decoupled)
> **Features**: KCISLK 自訂 Logo、英文瀏覽器標題、三種課表類型整合、英文班級純淨顯示、完整8堂課表顯示、智能搜尋、深色模式、完美響應式設計、z-index 層級系統、環境變數功能開關、專業黑白列印格式（班級/教師/學生）
> **Current Status**: ✅ 專案完全完成並優化 v2.4.1 - 所有功能已實現、班級課表列印功能完成、生產環境穩定運行、標準化 GitFlow 工作流程完成
